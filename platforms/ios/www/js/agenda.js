...
cday.prototype.finitial=function(_target){
	...
	//creer cadre d'agenda de jour president
	...
	//creer cadre d'agenda de jour corrant
...
cday.prototype.fafficher_rdvs=function(y,m,d,tbd){
	...
	if(acreneaux){
		for(var i in acreneaux){
			if(my2jd(acreneaux[i].ddeb).getDate()!=d)continue;
			this.fafficher_un_rdv(acreneaux[i],tbd);
		}
	}
...
cday.prototype.fafficher_un_rdv=function(ardv,tbd){
	...
	if(Math.abs(my2jd(ardv["ddeb"]).getTime()-new Date(this.oparent.current_annee,this.oparent.current_mois-1,this.oparent.current_date).getTime())>1000*60*60*24*2)return;
...
cweek.prototype.fafficher_rdvs=function(y,m,d,tbw){
	...
	var acreneaux=this.oparent.acreneaux[aday[0].getFullYear()+"_"+(aday[0].getMonth()+1)+"_"+aday[0].getDate()];
	if(acreneaux){
		for(var i in acreneaux)this.fafficher_un_rdv(acreneaux[i],tbw);
	}
